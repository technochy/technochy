    ...
    <footer id="contact" className="w-full bg-[#f3f3f3] text-[#111111] pt-12 pb-8 border-t border-gray-300">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="relative grid grid-cols-2 md:grid-cols-4 border border-gray-300 bg-white text-center">
          ...
          {navItems.map((item, idx) => (
            ...
            >
              ...
              <div className="w-2 h-2 bg-gray-300 group-hover:bg-[#7cff00] transition-colors flex-shrink-0"></div>
            </a>
          ))}
        </div>
        ...
        <div className="relative border border-gray-300 bg-[#f4f4f4] my-6 py-16 sm:py-24 px-6 text-center overflow-hidden group">
          ...
          {/* Top-Left Corner 8-Bit White Pixel Mosaic Art */}
          <div className="absolute top-0 left-0 pointer-events-none flex flex-col items-start z-10">
            <div className="flex">
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-white"></div>
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-white"></div>
            </div>
            <div className="flex">
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-white"></div>
          ...
          {/* Bottom-Right Corner 8-Bit White Pixel Mosaic Art */}
          <div className="absolute bottom-0 right-0 pointer-events-none flex flex-col items-end z-10">
            <div className="flex">
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-white"></div>
            </div>
            <div className="flex">
          ...
          <div className="flex items-center justify-center gap-4 sm:gap-6 relative z-20">
            ...
            {/* 3D Dark Hemisphere Logo Mark */}
            <div className="flex items-center gap-1 sm:gap-2">
              <div className="w-6 sm:w-10 h-14 sm:h-20 bg-gradient-to-r from-gray-700 to-black rounded-l-full shadow-xl transform -rotate-12 group-hover:rotate-0 transition-transform duration-500"></div>
              <div className="w-10 sm:w-16 h-20 sm:h-28 bg-gradient-to-r from-gray-900 to-black rounded-r-full shadow-2xl group-hover:scale-105 transition-transform duration-500"></div>
            </div>

...
export default function TestimonialsProcess() {
  ...
  const testimonials = [
    {
      quote: "Technochy built our entire affiliate tracking and publishers portal. Their Next.js implementation and secure API system handle millions of daily tracking requests seamlessly. Extremely professional team!",
      author: "JOHN MCKINLEY",
      role: "Founder & CEO @ Commissionbag.com",
      avatar: "https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?auto=format&fit=crop&w=600&q=80",
      rating: 5,
    },
    {
      quote: "We hired Technochy to design and develop our coupon directories. The sites load in milliseconds, have excellent SEO scores out of the box, and have substantially increased our conversion rates.",
      author: "ROBERT HENDRIX",
      role: "Managing Director @ Couponchy & WeSaveCart",
      avatar: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=600&q=80",
      rating: 5,
    },
    {
      quote: "Technochy designed our Shopify store and custom premium theme. The performance, micro-animations, and clean layout of our leather jackets catalog perfectly match our brand's luxury identity.",
      author: "ETHAN GAUDRY",
      role: "Creative Director @ Ovrone Canada",
      avatar: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?auto=format&fit=crop&w=600&q=80",
      rating: 5,
    },
    {
      quote: "Highly satisfied with their digital design and e-commerce development. They understood the elegant aesthetics required for our couture brand and delivered a stunning, ultra-fast online shopping experience.",
      author: "SARAH JENNINGS",
      role: "Luxury Retail Partner @ Amna Ismail US",
      avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=600&q=80",
      rating: 5,
    },
    {
      quote: "Technochy built our online menu and contactless ordering integration for our cafe in DHA Karachi. The interface is clean, intuitive, and has made online ordering completely hassle-free for our diners.",
      author: "DANIEL KRAUSE",
      role: "Digital Systems Consultant @ Mondo",
